...
MIC-specific analysis and validation utilities.
Genomics-related functions (PATRIC download helpers,
genome -> $k$-mer conversion, $k$-mer utilities, and similar) are now
depracated and have been ported to a new package,
